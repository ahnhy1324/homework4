...
model = tf.keras.models.Sequential(tf.keras.layers.Conv2D(32,7,activation="relu",padding="same",input_shape=(28,28,1)))
tf.keras.layers.MaxPooling2D(2)
model.add(tf.keras.layers.MaxPooling2D(pool_size=(2, 2)))
model.add(tf.keras.layers.Dropout(0.2))
model.add(tf.keras.layers.Flatten())
model.add(tf.keras.layers.Dense(127, activation='relu'))
